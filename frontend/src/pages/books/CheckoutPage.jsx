    ...
    return (
        <section className="min-h-screen bg-gray-100 flex flex-col items-center justify-center p-6 font-['Poppins']">
            <div className="container max-w-screen-md bg-white rounded-lg shadow-lg p-8">
                <h2 className="text-4xl font-['Poppins'] font-extrabold text-indigo-700 text-center mb-8" >🛒 Checkout</h2>
                        ...
                        <div className="grid gap-4 grid-cols-1 md:grid-cols-2">
                            ...
                            <div className="flex flex-col">
                                ...
                                <input
                                    ...
                                    className="h-10 border border-gray-300 rounded px-4 bg-gray-200 cursor-not-allowed"
                                />
                            </div>

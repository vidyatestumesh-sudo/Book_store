    ...
    <div className="max-w-2xl mx-auto md:p-6 p-3 bg-white rounded-lg shadow-md">
      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        ...
        <InputField
          label="About Book"
          name="aboutBook"
          placeholder="Enter short about book"
          type="textarea"
          register={register}
        />
        <InputField
        ...
        <InputField
          label="Binding"
          name="binding"
          placeholder="Enter binding type (Paperback/Hardcover)"
          register={register}
        />
        <InputField
          label="Publisher"
        ...
        <button
          type="submit"
          className="w-full py-2 mt-4 bg-green-500 text-white font-bold rounded-md">

          ...
          {viewMode === "form" && (
            <div className="mt-[50px]">
              <div className="bg-gradient-to-r from-blue-50 to-blue-100 shadow-xl rounded-2xl p-8 mb-10 border border-gray-500 transition-all duration-500">
                ...
                {/* Section for Inspiration Images */}
                <div className="bg-white shadow-md rounded-lg p-6 mb-12 border mt-10">
                  ...
                  <div className="grid grid-cols-3 gap-4">
                    ...
                    {inspirationImages.map((img) => (
                      ...
                      >
                        <img
                          src={
                            img.imageUrl // adjust this if your field name is different

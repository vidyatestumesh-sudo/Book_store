  ...
  return (
    <div className="container">
      ...
      <div className="mt-[100px]">
        <div className="max-w-8xl mx-auto grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-6">
          {/* Total Books */}
          <div
            className="group bg-white p-6 rounded-xl shadow-md border border-gray-100 hover:shadow-2xl transition duration-300 transform hover:-translate-y-1 cursor-pointer"
